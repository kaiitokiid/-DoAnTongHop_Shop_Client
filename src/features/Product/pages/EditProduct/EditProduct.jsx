...
function EditProduct() {
    document.title = 'ToMe - Chỉnh sửa sản phẩm'
    ...
    useEffect(() => {  
        ...
        .then(res => {
            if(res.data.isSuccess){
                ...
                setPreviewSource(res.data.data.image.path);
                setSelectedFile(res.data.data.image.path);
                setValue('name', res.data.data.name);
                setValue('categoryId', res.data.data.categoryId);
                setValue('originalPrice', res.data.data.originalPrice);
                setValue('salePrice', res.data.data.salePrice);
                setValue('branch', res.data.data.branch);
                setValue('originCountry', res.data.data.originCountry);
                setValue('otherInfo', res.data.data.otherInfo);
            }
        })
        .catch(err => {
            console.log(err);
